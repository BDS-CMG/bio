...
function turnDark() {
    ...
    liensRecrutement.style.color = 'white';
    poweredCMG.style.color = 'white';
    svgLinkedin.style.color = 'white';
    svgFacebook.style.color = 'white';

    //button
    //oldbutton.style.boxShadow = 'rgb(109 109 109 / 30%) -1px -4px 5px -2px, rgb(74 74 74 / 66%) 4px 4px 10px 0px, rgb(115 115 115) 4px 4px 4px 0px inset, rgb(134 134 134 / 62%) -4px -4px 4px 0px inset';
...
function turnLight() {
    ...
    liensRecrutement.style.color = '#0b2425';
